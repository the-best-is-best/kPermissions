...
mavenPublishing {
    ...
    pom {
        name.set("kPermissionsBluetooth")
        description.set("kPermissionsBluetooth provides Bluetooth permission support for the kPermissions library using Kotlin Multiplatform.")
...
kotlin {
    ...
    androidLibrary {
        namespace = "io.github.kpermissionsbluetooth"
    ...
    val xcfName = "kPermissionsBluetoothKit"
