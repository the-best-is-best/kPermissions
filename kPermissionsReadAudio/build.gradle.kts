...
mavenPublishing {
    ...
    pom {
        name.set("KPermissionsReadAudio")
        description.set("kPermissionsReadAudio is a Kotlin Multiplatform permission module that provides support for the `ReadAudio` permission on **Android** (API 33+).")
...
kotlin {
    ...
    androidLibrary {
        namespace = "io.github.kPermissionsAudio"
