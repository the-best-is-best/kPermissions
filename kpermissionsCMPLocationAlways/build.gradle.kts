...
mavenPublishing {
    coordinates("io.github.the-best-is-best", "kpermissions-cmp-location-always", "1.0.1")
...
kotlin {
    ...
    androidLibrary {
        namespace = "io.github.kpermissionscmplocationalways"
    ...
    val xcfName = "kpermissionsCMPLocationAlwaysKit"
    ...
    sourceSets {
        commonMain {
            dependencies {
                ...
                api(projects.kpermissionsLocationAlways)
            }
        }
