...
mavenPublishing {
    coordinates("io.github.the-best-is-best", "kpermissions-when-in-use", "1.0.0")

    publishToMavenCentral(SonatypeHost.S01, true)
    signAllPublications()

    pom {
        name.set("KPermissionsWhenInUse")
...
kotlin {
    ...
    androidLibrary {
        namespace = "io.github.kpermissionslocationWhenInUse"
    ...
    val xcfName = "kpermissionsLocationWhenInUseKit"
